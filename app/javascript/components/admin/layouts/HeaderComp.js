        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-x-3">
              <Moon className="w-5 h-5 hover:text-primary hover:w-8 hover:h-8 hover:transition-all cursor-pointer" />
              <Bell className="w-5 h-5 hover:text-primary hover:w-8 hover:h-8 hover:transition-all cursor-pointer" />
              <SettingsIcon className="w-5 h-5 hover:text-primary hover:w-8 hover:h-8 hover:transition-all cursor-pointer" />
              <Clock className="w-5 h-5 hover:text-primary hover:w-8 hover:h-8 hover:transition-all cursor-pointer" />
